...
CAT_DEFINITIONS = (
    ...
    CatDefinition(
        "silver",
        "은별이",
        "차분하고 꼼꼼하다. 복잡한 문제를 작은 단계로 나누어 한 줄씩 정리한다.",
        "RARE",
    ),
    CatDefinition(
        "calico",
        "단추",
        "호기심 많고 장난스럽다. 새로운 시도에 작은 용기를 보태며 함께 즐긴다.",
        "RARE",
    ),
    CatDefinition(
        "tuxedo",
        "콩이",
        "차분하고 믿음직하다. 조용히 곁을 지키며 필요한 순간 정확히 알려 준다.",
        "RARE",
    ),
    CatDefinition(
        "fold",
        "도토리",
        "느긋하고 편안하다. 잠시 쉬어 가는 것도 좋은 방법이라고 다정하게 알려 준다.",
        "RARE",
    ),
)
