...
# Extra, non-story-flavoured cases used only for grading (never shown as the public example).
# Generated by actually executing each operation's reference solution across representative and
# edge-case inputs (zero, negative, boundary, duplicates, ties, empty input, ...), so a hardcoded
# single-output submission can no longer pass every visible variant of a task.
EXTRA_CASES: dict[str, list[tuple[str, str]]] = {
    "sum": [("0 0\n", "0\n"), ("-3 5\n", "2\n"), ("5 -3\n", "2\n"), ("-1 -1\n", "-2\n"), ("1000000 1000000\n", "2000000\n"), ("7 7\n", "14\n"), ("999999 1\n", "1000000\n"), ("-500 -500\n", "-1000\n"), ("0 -8\n", "-8\n")],
    "length": [("\n", "0\n"), ("a\n", "1\n"), ("a b c\n", "5\n"), ("12345\n", "5\n"), ("가나다라마\n", "5\n")],
    "even": [("0\n", "야옹~\n"), ("1\n", "갸우뚱...\n"), ("-2\n", "야옹~\n"), ("-3\n", "갸우뚱...\n"), ("100\n", "야옹~\n"), ("99\n", "갸우뚱...\n"), ("2\n", "야옹~\n")],
    "range_sum": [("1\n", "1\n"), ("0\n", "0\n"), ("10\n", "55\n"), ("100\n", "5050\n"), ("2\n", "3\n")],
    ...
    "best_scores": [("amy:5 bob:3 cathy:7\n", "15\n"), ("amy:10\n", "10\n"), ("amy:1 amy:2 amy:3\n", "3\n")],
    "gcd": [("17 5\n", "1\n"), ("9 9\n", "9\n"), ("0 5\n", "5\n"), ("100 75\n", "25\n"), ("7 13\n", "1\n")],
    "pair_sum": [("1 2 3\n100\n", "0\n"), ("3 3 5\n6\n", "1\n"), ("2 2 2\n4\n", "3\n")],
...
def cases(operation: str, variant: int) -> list[dict[str, str]]:
    ...
    combined = data[operation] + EXTRA_CASES.get(operation, [])
    return [{"input": item[0], "expected_output": item[1]} for item in combined]
