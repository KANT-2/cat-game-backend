...
@pytest.mark.parametrize(
    ...
    [
        ...
        # so both digests were recomputed on purpose. The Python digest was recomputed again when
        # every operation's test_cases grew from 1-2 hand-picked cases to several (mostly 5-10),
        # generated by executing each operation's own reference solution across edge-case inputs -
        # closing a hardcoded-single-output cheat without changing any grading logic.
        (python_seed, "0f0bb49dc3dc56eea7a3d36bc38e5b27df784e98d126015fb9e9d1e6ae162fb4"),
